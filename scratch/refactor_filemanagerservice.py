...
path = 'Services/FileManagerService.swift'
...
content = content.replace(old_copy_sig, new_copy_sig)
content = content.replace(old_merge_sig, new_merge_sig)
...
content = content.replace(old_copy_body, new_copy_body)
